...
include_once "entidades/venta.php"; //Se utiliza para vincular y obtener datos
include_once "entidades/cliente.php"; //Se utiliza para vincular y obtener datos
include_once "entidades/producto.php"; //Se utiliza para vincular y obtener datos
